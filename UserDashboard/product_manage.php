...
<html lang="en">
    <head>
        ...
        <title>Product_management - SB user</title>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="product_manage.php">Order Product</a>
                                </nav>
                            </div>
                    ...
                    <!-- <div class="container-fluid px-4"> -->
                       ...
                       <div class="container my-3">
                           <!-- <h3 class="text-center">Welcome to online product management system</h3> -->
                            <button type="" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#completeModel">
                              Product info
                            </button>
